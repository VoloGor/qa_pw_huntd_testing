...
Error: strict mode violation: getByLabel('Password') resolved to 2 elements:
    1) <input value="" id="password" type="password" name="password" aria-disabled="false" autocomplete="new-password" class="FormInputs_input__HDCuT InputPassword_password__VyV79"/> aka getByRole('textbox', { name: 'Password', exact: true })
    2) <input value="" type="password" id="repeatPassword" aria-disabled="false" name="repeatPassword" autocomplete="new-password" class="FormInputs_input__HDCuT InputPassword_password__VyV79"/> aka getByRole('textbox', { name: 'Repeat password' })
...
```ts
  ...
  11 |     this.passwordInput = this.host.getByLabel('Password');
  12 |     this.repeatPasswordInput = this.host.getByLabel('Repeat password');
